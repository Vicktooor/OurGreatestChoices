...
namespace Assets.Script {
    public class Blink : MonoBehaviour {
        ...
        void Start() {
            ...
            _fillBar = transform.Find("Fill Area").GetComponentInChildren<Image>();
            rezcolor = Color.red; // The current value of the color of the text.
        }
        ...
        private void FixedUpdate() {
            ...
            _fillBar.color = new Color(rezcolor.r, rezcolor.g, rezcolor.b, alphazxc);
        }
    }
}
